 ...
 *
 */
public class AppliedToPanel extends MyScrollPanel{
private JButton btnBack;
	...
	public AppliedToPanel(ActionListener packageListener) {
		...
		contentPane.setName("Applied To Panel");
	...
	private void displayNorth() {
		lblSuccess = new MyLabel("Scholarships you have applied to", Size.defaultLblSubTitleFontSize);
	...
	public void addScholarship(Scholarship scholarship, int priority) {
	    ...
	    center.add(cb, String.format("cell 4 %d, left",y));
